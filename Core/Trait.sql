...
VALUES		('GRAM_NESS_DIPLO_FAVOR_NATURAL_WONDERS',			'MODIFIER_GRAM_FAVOR_NATURAL_WONDERS',			
			...
			('GRAM_NESS_GIVE_DIPLO_FAVOR',						'MODIFIER_PLAYER_ADD_FAVOR',
			NULL,												NULL										),					
...
VALUES		('MODIFIER_GRAM_FAVOR_NATURAL_WONDERS',		'COLLECTION_PLAYER_CITIES',		'EFFECT_ADJUST_PLAYER_EXTRA_FAVOR_PER_TURN'		),
			--('MODIFIER_GRAM_NESS_GIVE_DIPLO_FAVOR',		'COLLECTION_OWNER',				'EFFECT_ADD_PLAYER_FAVOR'						),
			('MODIFIER_GRAM_NESS_GIVE_CULTURE',			'COLLECTION_OWNER',				'EFFECT_ADJUST_PLAYER_YIELD_CHANGE'				);
